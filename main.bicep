...
// --- Azure OpenAI: Chat API (corresponds to AZURE_OPENAI_CHAT_*)
...
param azure_openai_chat_system_prompt string
      ...
      containers: [
        {
          ...
          env: [
            ...
            {
              name: 'AZURE_OPENAI_CHAT_SYSTEM_PROMPT'
              value: azure_openai_chat_system_prompt
            }
            {
